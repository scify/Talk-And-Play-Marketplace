...
return [
    ...
    'communication_cards_tutorial_step_4_description' => 'Κατέβασε την εφαρμογή για <a href="https://go.scify.gr/talkandplaylinux">Linux</a> και για <a href="https://go.scify.gr/talkandplayexe">Windows</a>.',
    ...
    'game_cards_tutorial_step_4_description' => 'Κατέβασε την εφαρμογή για <a href="https://go.scify.gr/talkandplaylinux">Linux</a> και για <a href="https://go.scify.gr/talkandplayexe">Windows</a>.',
    ...
    'info_pending_approval' => 'Το πακέτο της κάρτας έχει υποβληθεί για έγκριση από τον διαχειριστή. Εάν το περιεχόμενο συμμορφώνεται με τους κανόνες, τότε θα είναι διαθέσιμο για λήψη μετά από ειδοποίηση μέσω ηλεκτρονικού ταχυδρομείου.',
    'info_approved' => 'Το πακέτο καρτών έχει εγκριθεί και είναι πλέον διαθέσιμο στην πλατφόρμα για να το δουν και να το κατεβάσουν όλοι!',
    'info_rejected' => 'Το πακέτο της κάρτας απορρίφθηκε καθώς δεν συμμορφώνεται με τους κανόνες. Για περισσότερες εξηγήσεις, ανατρέξτε στο μήνυμα ηλεκτρονικού ταχυδρομείου που εστάλη στην καταχωρημένη διεύθυνσή σας.',
    ...
    'reported_packages' => 'Πακέτα με Αναφορές',
    'approve' => 'Έγκριση',
    'reject' => 'Απόρριψη',
    'report' => 'Αναφορά',
    'select_rejection_reason' => 'Επίλεξε τον λόγο της απόρριψης',
    ...
    'terms-of-service-link' => 'https://go.scify.gr/tnp-marketplace-terms-gr',
    'privacy-policy-link' => 'https://go.scify.gr/tnp-marketplace-privacy-gr',
    'cookies-policy-link' => 'https://go.scify.gr/tnp-marketplace-cookies-gr',
    'cookies-policy' => 'Πολιτική Cookies',
    'funding-footer' => 'Αυτό το έργο έχει λάβει χρηματοδότηση από το πρόγραμμα έρευνας και καινοτομίας Horizon 2020 της Ευρωπαϊκής Ένωσης με αριθμό επιχορήγησης 857159.',
