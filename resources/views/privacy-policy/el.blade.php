                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <b>2.1.</b> Ο λειτουργικός σκοπός της Πλατφόρμας είναι να επιτρέψει σε χρήστες να δημιουργήσουν περιεχόμενο που θα χρησιμοποιηθεί από την
                                αντίστοιχη υποστηρικτική εφαρμογή.
                                Έπειτα, το περιεχόμενο που αναρτάται από τους χρήστες υπόκειται σε έλεγχο από έναν διαχειριστή ώστε να δημοσιευτεί.
                                Για το συγκεκριμένο σκοπό της επεξεργασίας, η νομική βάση είναι η προηγούμενη συγκατάθεση του Χρήστη.
                                <br><br>
                            ...
                            <div class="col-12">
                                ...
                                <table class="table table-striped table-responsive table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>tnp_marketplace_cookies_consent_selection, tnp_marketplace_cookies_consent_targeting (Αποθηκεύει την κατάσταση συναίνεσης cookie του χρήστη για το συγκεκριμένο τομέα)
                                            <br><br>
                                            ...
                                            <br><br>
                                            remember_web_*, tnp_marketplace_session (Όταν η εφαρμογή πρέπει να ‘θυμάται’ τους συνδεδεμένους χρήστες όσο αυτοί περιηγούνται στην Πλατφόρμα)
                                            <br><br>
