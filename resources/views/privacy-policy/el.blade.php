                                ...
                                <table class="table table-striped table-responsive table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>CookieConsent (Αποθηκεύει την κατάσταση συναίνεσης cookie του χρήστη για το συγκεκριμένο τομέα)
                                            ...
                                            <br><br>
                                            remember_web_59ba36addc2b2f9401580f014c7f58ea4e30989d (Όταν η εφαρμογή πρέπει να ‘θυμάται’ τους συνδεδεμένους χρήστες όσο αυτοί περιηγούνται στην Πλατφόρμα)
                                        </td>
                                        <td>1 χρόνο
                                            <br><br>
                                            <br><br>
