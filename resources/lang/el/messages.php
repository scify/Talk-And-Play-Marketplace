...
return [
    ...
    'term-of-use-11' => 'Με εξαίρεση τους όρους της προηγούμενης παραγράφου σχετικά με τα προσωπικά δεδομένα, η <a href="http://www.scify.org/" target="_blank" rel="noopener noreferrer">  SciFY </a>, διατηρεί το δικαίωμα να αλλάζει τους Όρους και Προϋποθέσεις Χρήσης, αν χρειάζονται επικαιροποίηση και συμπλήρωση, οποτεδήποτε και χωρίς προειδοποίηση, οπότε ο χρήστης θα πρέπει να ενημερώνεται για τυχόν αλλαγές πριν από κάθε χρήση της εφαρμογής.',
    'term-of-use-10' => 'Η <a href="http://www.scify.org/" target="_blank" rel="noopener noreferrer">  SciFY </a> χρησιμοποιεί προσωπικά στοιχεία που καταχωρεί κάθε χρήστης μόνο στο πλαίσιο του έργου <a href="https://talkandplay.scify.org/" target="_blank" rel="noopener noreferrer"> Talk & Play Marketplace </a>, για στατιστικούς λόγους και για να έρθει σε επαφή μαζί του, αν χρειαστεί. Προσωπικά στοιχεία δεν κοινοποιούνται σε τρίτους χωρίς την άδεια του χρήστη.',
    ...
    'term-of-use-7' => 'Η <a href="http://www.scify.org/" target="_blank" rel="noopener noreferrer"> SciFY </a> δεν είναι σε θέση να εγγυηθεί για την καταλληλότητα του περιεχομένου άλλων δημιουργών παιχνιδιών του <a href="https://talkandplay.scify.org/" target="_blank" rel="noopener noreferrer"> Talk & Play Marketplace </a>. Διατηρεί όμως το δικαίωμα να ζητήσει από το δημιουργό διορθώσεις ή και να διαγράψει το περιεχόμενο, αν κάτι μη αποδεκτό πέσει στην αντίληψή της. Οι χρήστες ενθαρρύνονται να ενημερώσουν τη SciFY για μη αποδεκτό περιεχόμενο.',
    ...
    'term-of-use-4' => 'H <a href="http://www.scify.org/" target="_blank" rel="noopener noreferrer">  SciFY </a> δεν ευθύνεται για την ποιότητα/την καταλληλότητα του περιεχομένου ή το περιεχόμενο που μεταφορτώνεται στην εφαρμογή, την ορθότητα ή την ποιότητά του, παρά μόνο για το περιεχόμενο που έχει ανεβάσει η ίδια ως δημιουργός.',
    'term-of-use-3' => 'Η εφαρμογή <a href="https://talkandplay.scify.org/" target="_blank" rel="noopener noreferrer"> Talk & Play Marketplace </a> απευθύνεται σε φορείς και επιστήμονες που ασχολούνται με την φροντίδα και την αποκατάσταση ατόμων που ανήκουν στις ομάδες που περιγράφηκαν παραπάνω, καθώς και σε άτομα που παρέχουν σχετική φροντίδα στο σπίτι.',
    'term-of-use-2' => 'Το περιεχόμενο του <a href="https://talkandplay.scify.org/" target="_blank" rel="noopener noreferrer"> Talk & Play Marketplace </a>  απευθύνεται κυρίως σε άτομα χωρίς νοητικά προβλήματα, που έχουν όμως πρόβλημα επικοινωνίας λόγω κινητικών δυσκολιών ή και δυσκολιών στην ομιλία (π.χ. τραχειοστομία συνδυασμένη με κινητικά προβλήματα), καθώς και άτομα με αφασία (π.χ. λόγω εγκεφαλικής βλάβης).',
    'term-of-use-1' => 'Το <a href="https://talkandplay.scify.org/" target="_blank" rel="noopener noreferrer"> Talk & Play Marketplace </a> είναι μια διαδικτυακή εφαρμογή που υλοποίησε και διαθέτει δωρεάν η Αστική Μη Κερδοσκοπική Εταιρεία  <a href="http://www.scify.org/" target="_blank" rel="noopener noreferrer">  SciFY </a>, ώστε ο καθένας να μπορεί να δημιουργεί και να μοιράζεται με άλλους δωρεάν περιεχόμενο για την  <a href=https://play.google.com/store/apps/details?id=org.scify.dianoia.app" target="_blank" rel="noopener noreferrer">εφαρμογή Διάνοια </a>.',
    ...
    "rejection_violation_terms" => "Αυτή η άσκηση παραβιάζει τους όρους χρήσης της πλατφορμας",
    "rejection_inappropriate_content" => "Αυτή η άσκηση περιέχει ακατάλληλο περιεχόμενο",
    "rejection_copyright" => "Αυτή η άσκηση παραβιάζει τους κανονισμούς περί πνευματικής ιδιοκτησίας",
    "rejection_not_readable" => "Tο περιεχόμενο της άσκησης δεν είναι ευκρινές / ευανάγνωστο",
    "other" => "Άλλο",
];
